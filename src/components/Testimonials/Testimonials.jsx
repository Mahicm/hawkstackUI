...
export default function Testimonials() {
  ...
  <div className="relative w-full py-20 overflow-hidden bg-[#0b0c10]">
  ...
  >
    <p className="font-normal text-[14px] text-white">Client Success Stories</p>
  </div>
       ...
       <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-10 w-full max-w-6xl">
         ...
         <div className="relative rounded-2xl bg-gradient-to-br from-[#24262F]/60 to-[#1A1B22]/40 p-8 border border-white/10 backdrop-blur-md shadow-xl">
           ...
           <p className="mt-5 text-[#FFFFFF] italic leading-relaxed text-[16px] font-normal">
             “HawkStack delivered exceptional results in our cloud migration project.
             Their Red Hat expertise was invaluable.”
           </p>
           ...
           <div className="mt-6">
             ...
             <p className="text-gray-500 text-sm">Global Technology Services</p>
           </div>
         </div>
       ...
       <div className="flex items-center gap-1 mt-3 ">
           ...
           <p className="mt-5 text-[#FFFFFF] leading-relaxed italic text-[16px] font-normal">
             “Professional team with deep technical knowledge. They helped us modernize
       ...
       <div className="mt-20 w-full max-w-3xl rounded-2xl bg-gradient-to-br 
